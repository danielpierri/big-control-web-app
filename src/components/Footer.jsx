      ...
      <footer className="footer">
        <div>
          <ul className="footer__contact">
            ...
            <li><i className="fa-solid fa-envelope"></i> <a href="mailto:evandro@bigcontrol.com.br" target="_blank" rel="noreferrer">evandro@bigcontrol.com.br</a></li>
          ...
          <ul className="footer__social-media">
            ...
            <li><a href="https://www.facebook.com" target="_blank" rel="noreferrer"><i className="fa-brands fa-square-facebook"></i></a></li>
            ...
            <li><a href="https://wa.me/5521993395960?" target="_blank" rel="noreferrer"><i className="fa-brands fa-whatsapp"></i></a></li>
          </ul>
          <p className="signature">Desenvolvido por <a href="https://github.com/danielpierri" target="_blank" rel="noreferrer">Daniel Pierri <i className="fa-brands fa-github"></i></a></p>
        </div>
